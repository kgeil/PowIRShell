...
#import-Module C:\scripts\PowIRShell\Get-IPAddressInfo.psm1
import-Module C:\Scripts\PowIRShell\IP_ThreatIntelOps\Get-IPAddressInfo.psm1
import-Module C:\Scripts\PowIRShell\M365-IRSupportingScripts\Get-M365info.psm1
#import-Module Get-IPAddressInfo #currently located at C:\scripts\PowIRShell\Get-IPAddressInfo
#import-Module Get-AuditdataFrom365JSON #currently located at C:\Scripts\PowIRShell\M365-IRSupportingScripts\Get-M365info.psm1
$Logevents = Get-AuditdataFrom365JSON -searchdir $searchdir
$iplist =  Get-UniqueIPs -auditevents $Logevents
$badip = @()
